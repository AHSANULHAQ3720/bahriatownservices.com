...
<script type="text/javascript">
    function printpage() {
        //Get the print button a$nd put it into a variable
...
// Create connection
    ...
    // output data of each row
     ...
     // /  echo "<script type='text/javascript'>alert('$t');</script>";
      ...
      <li>For electricity BILL compalints Phase 1 to 6 dial.5731500 (129,140,141)</li>
      <li>For queries regarding Electric Bill Phase 8  Dial <b>5410387 </b></li>
      <li>Minimum charges
      <ol>
